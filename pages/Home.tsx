...
import { SHOP_LOCATION, OPENING_HOURS } from '../constants';
    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="relative h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-teal-600/60 via-teal-500/45 to-orange-500/50"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left">
          <div className="max-w-2xl animate-in fade-in slide-in-from-left-8 duration-1000">
            ...
            <h1 className="text-5xl md:text-7xl text-white mb-6 leading-tight font-black">
              Mindig <span className="text-orange-200">számíthat</span> ránk.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
              <Link to="/ujsag" className="bg-white text-teal-700 px-8 py-4 rounded-full text-lg font-bold hover:bg-orange-50 transition-all shadow-xl hover:scale-105 active:scale-95 text-center">
                Aktuális Termékújság
              </Link>
              <Link to="/szolgaltatasok" className="bg-white/20 backdrop-blur-md text-white border border-white/40 px-8 py-4 rounded-full text-lg font-bold hover:bg-white/30 transition-all text-center">
                Szolgáltatásaink
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-teal-600 text-white rounded-full flex items-center justify-center text-2xl mb-6 mx-auto">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="bg-gradient-to-r from-teal-500 to-orange-500 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden">
          ...
          <p className="text-white/90 text-xl mb-12 max-w-3xl mx-auto relative z-10 font-light">
          ...
          <div className="flex flex-wrap justify-center gap-6 relative z-10">
            ...
            <div className="flex flex-col items-center gap-1 bg-white/20 px-6 py-3 rounded-2xl backdrop-blur text-sm text-center">
              <div className="flex items-center gap-2 font-semibold">
                <i className="fas fa-clock"></i>
                <span>Nyitvatartás</span>
              </div>
              {OPENING_HOURS.filter(h => h.hours !== 'Zárva').map((h, i) => (
                <div key={i}>
                  <span className="font-medium">{h.day}: </span>
                  <span>{h.hours}</span>
                  {h.lunchBreak && (
                    <span className="opacity-75 ml-1">(Ebédszünet: {h.lunchBreak})</span>
                  )}
                </div>
              ))}
            </div>
